...
const Contact = () => {
  return (
    <div className="mt-20 min-h-screen flex flex-col items-center bg-gray-100 px-4 py-10">
      ...
      <div className="w-full max-w-4xl bg-white shadow-lg rounded-lg p-6">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          />
          <textarea
            className="border border-gray-300 p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400 col-span-1 md:col-span-2"
      ...
      {/* Contact Info */}
      <div className="w-full max-w-4xl mt-8 bg-white shadow-lg rounded-lg p-6 text-center">
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">
          QuickBite - Have a Bite
        </h2>
        <p className="text-gray-600 mb-2">📍 Roorkee, Uttarakhand</p>
        <p className="text-gray-600 mb-2">📞 +91-8787952601</p>
        <p className="text-gray-600">📧 contact@quickbite.com</p>
      </div>
