...
const ShimmerMenuItemRow = () => (
  <div className="flex justify-between items-center p-4 border-b">
    ...
    <div className="w-[120px] h-[120px] bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse flex-shrink-0" />
  </div>
);
...
const ShimmerMenu = () => {
  return (
    <div>
      <div className="w-full h-[200px] mt-[90px] bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800 animate-pulse" />
      <div className="max-w-screen-2xl mx-auto py-12 px-16">
        <div className="h-8 w-64 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-10 animate-pulse" />
        <ShimmerMenuCategory />
        <ShimmerMenuCategory />
        <ShimmerMenuCategory />
      </div>
