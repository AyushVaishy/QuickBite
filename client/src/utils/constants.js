export const CDN_URL =
  ...
  'https://www.swiggy.com/mapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=29.8542626&lng=77.8880002&restaurantId=';
...
export const apiKey = process.env.REACT_APP_RAPIDAPI_KEY || "";
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        description:
          "Extra discount is applicable on effective item total, which is item total after the coupon discount has been applied",
        conversationId: null,
        layerConversationId: null,
        ackText: null,
        isLeaf: true,
      ...
      },
      {
        ...
        description:
          "Free delivery covers all delivery charges such as delivery fee, late night surcharge & surge fee, which may apply when there's high demand, bad weather, or on special occasions. ",
        conversationId: null,
        layerConversationId: null,
        ackText: null,
        isLeaf: true,
      ...
      },
      {
        ...
        description:
          "You can re-purchase the membership after your current plan expires. You cannot renew before plan expires",
        conversationId: null,
        layerConversationId: null,
        ackText: null,
        isLeaf: true,
      ...
      },
      {
        ...
        description:
          "Instamart is available in select locations, we are rolling it out to more locations soon. You enjoy Unlimited free delivery above INR 199 and Extra discounts on select items in all active Instamart locations.",
        conversationId: null,
        layerConversationId: null,
        ackText: null,
        isLeaf: true,
      ...
      },
      {
        ...
        description:
          "No, you can enjoy unlimited free deliveries on all order values above INR 199.",
        conversationId: null,
        layerConversationId: null,
        ackText: null,
        isLeaf: true,
      ...
      },
      {
        id: 100330,
        title:
          "Has the minimum order value to avail free delivery on Instamart changed?",
        description:
          "Yes, the minimum order value has changed to Rs. 199 as of Nov 22, 2022. Any user who buys or renews membership post this date will be able to avail free delivery above Rs. 199.",
        conversationId: null,
        layerConversationId: null,
        ackText: null,
        isLeaf: true,
      ...
      },
      {
        id: 100503,
        title:
          "Does moneyback also provide a credit if I am unhappy with the ordering experience? Will I get my subscription amount credited back? Or will I get my order amount credited back?",
        description:
          "No. The moneyback will be calculated only based on the total cumulative savings achieved during the membership tenure.",
        conversationId: null,
        layerConversationId: null,
        ackText: null,
        isLeaf: true,
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        description:
          "As a hospitality gesture, the restaurant will hold your reservation for 15 minutes from your deal timings, however, this is subject to availability at the restaurant premises. We urge you to arrive on time at your restaurant to avail your offer.",
        conversationId: null,
        layerConversationId: null,
        ackText: null,
        isLeaf: true,
      ...
      },
      {
        ...
        description:
          "GIRF deals once purchased cannot be canceled, modified, refunded, or transferred, even if the deal was not redeemed.",
        conversationId: null,
        layerConversationId: null,
        ackText: null,
        isLeaf: true,
      ...
      },
      {
        ...
        description:
          "Kindly check all offer details along with T&C on the deal page before buying. Note that the offer may not be applicable on certain menu items as per the restaurant’s policy. Also, mention your GIRF deal and show the confirmation SMS to the Manager/Waiter at the restaurant, before placing your order. Service charges may be applicable at the discretion of the restaurant.",
        conversationId: null,
        layerConversationId: null,
        ackText: null,
        isLeaf: true,
